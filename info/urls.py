...
urlpatterns = [
    ...
    path('relations/', views.CollectionRecordListView.as_view(), name='relation-list'),
    # path('relations/create', views.CollectionRecordCreateView.as_view(), name='relation-create'),
    path('collections/<int:pk>/relations/create', views.CollectionRecordCreateView.as_view(), name='relation-create'),
